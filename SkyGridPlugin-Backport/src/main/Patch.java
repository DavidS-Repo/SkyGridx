...
public class Patch {
	...
	public static void patchFiles(CommandSender sender, SkyGridPlugin plugin) {
		boolean filesPatched = copyFilesFromJar("world.yml", "SkygridBlocks", plugin) &&
				copyFilesFromJar("world_nether.yml", "SkygridBlocks", plugin) &&
				copyFilesFromJar("world_the_end.yml", "SkygridBlocks", plugin) &&
